...
public interface MovieRepository extends JpaRepository<Movie, Long>, MovieRepositoryCustom {
        ...
        @Query("SELECT m FROM Movie m WHERE m.isEnable = :isEnabled AND m.isBanner = :isBanner")
        List<Movie> getBMovieBanner(Boolean isEnabled, Boolean isBanner);
}
