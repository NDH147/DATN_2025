...
public class BillController {
    ...
    @PutMapping("/bill/update-ticket-issued")
    public ResponseEntity<?> updateIsTicketIssued(@RequestParam String billCode,
                                          @RequestParam Boolean isTicketIssued){
        String message = billService.updateIsTicketIssued(billCode, isTicketIssued);
